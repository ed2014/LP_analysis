...
## Compare observed and simulated time-series 
...
## How does the best fit(s) look in terms of RMSE by depth?
...
g1 %>%
  ...
  filter(Crop == "Lucerne") %>%
  ggplot(aes(x=Depth_mm, y=StatsValue, colour=factor(Stage))) +
  geom_point() +
  geom_line() +
 # geom_bar(aes(stats='identity')) +
