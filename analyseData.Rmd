...
dataRaw <- read.csv("C:\\GitHubRepos\\LP_analysis\\ObsPre.csv", header = TRUE)

dataWork <- as.data.frame(dataRaw)

#dataWork$Date <- as.Date(dmy_hm(dataRaw$Date))
dataWork$Date <- as.Date(dmy(dataRaw$Date))
