...
- Equifinality aspects to discuss
...
rangeBestFit <- 0.05 # % of value around rRMSE and LC
...
statDF_crop_stage_irrig %>%
  ...
  geom_vline(data=temp_data_bf,aes(xintercept=temp_data_bf$lc), linetype=2) + 
 geom_hline(data=temp_data_bf, aes(yintercept=temp_data_bf$r_rmse), linetype=2) 
# geom_vline(data=temp_data_bf,aes(xintercept=temp_data_bf[temp_data_bf$BestFit=="Best",]$lc), linetype=2) + 
# geom_hline(data=temp_data_bf, aes(yintercept=temp_data_bf[temp_data_bf$BestFit=="Best",]$r_rmse), linetype=2) 
