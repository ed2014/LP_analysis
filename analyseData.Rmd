...
```{r PlotSimPop2, fig.height=10,fig.width=15, echo=FALSE, warning=FALSE}
...
## Picking "the single best" parameter combination

As a example, and aware of equifinality issues shown above, let's choose a cretiria to select only one best parameter combination.

Subjective criteria for selection:

- Subset the 15% "less biased" simulations (i.e. low SB or pBias close to zero)
...
# re-arrange as table df
 ...
 # Isolate the best RFV value for each crop 
...
# Select best parameters for dryland conditions
